...
$sql = "INSERT INTO complaint (cid, userID, userType, subject, complaint, timey,uname) VALUES (NULL, '$_COOKIE[userID]', 'student', '$subject','$complaint', current_timestamp,'$name');";
